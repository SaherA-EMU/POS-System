        ...
        <div className="item-cart">
            ...
            <div className="item-cart-container">
                <div className="item-cart-totals">
                    <span>Subtotal:</span>
                        <input type="text" className="item-cart-subtotal" placeholder="$0.00" disabled/><br/>
                    <span>Tax Amt:</span>
                        <input type="text" className="item-cart-tax" placeholder="$0.00" disabled/><br/>
                    <span>Total:</span>
                        <input type="text" className="item-cart-total" placeholder="$0.00" disabled/><br/>
                </div>
